...
<head>
    ...
    <title>Medicine Sales History Report</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .status-partial { background-color: #fef3cd; color: #856404; }
...
<body>
        ...
        <tbody>
            @foreach($sales as $index => $sale)
                <tr>
                    ...
                    <td>{{ $sale->patient->name ?? 'Walk-in Customer' }}</td>
    ...
    <div class="footer">
        <p>Eye Hospital Management System - Medicine Sales Report</p>
