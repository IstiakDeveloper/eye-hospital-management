...
import { Activity, Eye, Pill, Receipt, TestTube, TrendingUp, Wallet } from 'lucide-react';
...
const MainAccountLayout: React.FC<MainAccountLayoutProps> = ({ children, title = 'Reports' }) => {
