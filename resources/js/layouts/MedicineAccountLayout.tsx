...
const MedicineAccountLayout: React.FC<MedicineAccountLayoutProps> = ({ children, title = 'Medicine Account' }) => {
    const navigation = [
        {
            name: 'Dashboard',
                            ...
                            return (
                                <Link
                                    ...
                                    className={`flex items-center px-4 py-3 text-sm font-medium transition-colors ${
                                        item.current
                                            ? 'border-r-2 border-green-700 bg-green-50 text-green-700'
                ...
                <div className="flex-1 overflow-auto">
                    <div className="p-6">
                        <div className="mb-6 flex items-center justify-between">
                            ...
                            <div className="text-sm text-gray-500">Medicine Financial System</div>
                        </div>
                        {children}
                    </div>
                </div>
