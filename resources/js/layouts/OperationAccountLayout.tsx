...
import { BarChart3, FileText, History, PieChart, Scissors, TrendingUp } from 'lucide-react';
...
const OperationAccountLayout: React.FC<OperationAccountLayoutProps> = ({ children, title = 'Operation Account' }) => {
    const navigation = [
        {
            name: 'Dashboard',
                ...
                <div className="flex-1 overflow-auto">
                    <div className="p-6">
                        <div className="mb-6 flex items-center justify-between">
                            ...
                            <div className="text-sm text-gray-500">Operation Financial System</div>
                        </div>
                        {children}
                    </div>
                </div>
