            ...
            <div className="mb-8">
                <div className="rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-white">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="mb-2 text-2xl font-bold">Good morning, {userName}! 👋</h1>
                        ...
                        <div className="flex space-x-3">
                            ...
                            <Button asChild variant="outline" className="bg-white text-blue-600 hover:text-blue-500">
            ...
            <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-5">
                <Card className="border-green-200 bg-gradient-to-br from-green-50 to-emerald-50">
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-green-600">Today's Registrations</p>
                ...
                <Card className="border-purple-200 bg-gradient-to-br from-purple-50 to-violet-50">
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-purple-600">Vision Tests Done</p>
                ...
                <Card className="border-orange-200 bg-gradient-to-br from-orange-50 to-amber-50">
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-orange-600">Pending Appointments</p>
                ...
                <Card className="border-red-200 bg-gradient-to-br from-red-50 to-pink-50">
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-red-600">Waiting Patients</p>
                                            ...
                                            <div className="text-right">
                                                ...
                                                <div className="mt-2">
                                                    <Button size="sm" variant="outline" asChild>
                                                        <Link href={route('patients.show', appointment.patient.id)}>View Patient</Link>
                                                    </Button>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            {todayAppointments.length > 6 && (
                                <div className="mt-4 text-center">
                                    <Button variant="outline" asChild>
                                        <Link href={route('appointments.index')}>View All Appointments</Link>
                                    </Button>
                                </div>
                            )}
                        </CardContent>
                                    ...
                                    patientsNeedingVisionTest.slice(0, 5).map((patient) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex space-x-2">
                                                ...
                                                <Button size="sm" variant="outline" asChild>
                                                    <Link href={route('patients.show', patient.id)}>View</Link>
                                                </Button>
                                            </div>
                                        </div>
                                    ))
                        ...
                        <CardContent>
                            ...
                            <div className="mt-4">
                                <Button variant="outline" className="w-full" asChild>
                                    <Link href={route('patients.index')}>View All Patients</Link>
                                </Button>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent>
                            <div className="space-y-3">
                                {recentVisionTests.slice(0, 5).map((test) => (
                                    <div key={test.id} className="rounded-lg border border-purple-200 bg-purple-50 p-3">
                                        ...
                                        <div className="mt-2">
                                            <Button size="sm" variant="ghost" className="h-6 text-xs" asChild>
                                                <Link href={route('visiontests.show', test.id)}>View Details</Link>
                                            </Button>
                                        </div>
                                    </div>
                                ))}
                        ...
                        <CardContent>
                            <div className="space-y-3">
                                {appointmentsByDoctor.map((doctor, index) => (
                                    <div key={index} className="rounded-lg border border-indigo-200 bg-indigo-50 p-3">
                                        <div className="mb-2 flex items-center justify-between">
                                            <h4 className="font-medium text-gray-900">Dr. {doctor.doctor_name}</h4>
                                            <Badge className="bg-indigo-100 text-indigo-800">{doctor.appointments_count} patients</Badge>
                                        </div>
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                            {upcomingAppointments.slice(0, 6).map((appointment) => (
                                <div key={appointment.id} className="rounded-lg bg-gray-50 p-4 transition-colors hover:bg-gray-100">
                                    <div className="mb-2 flex items-center justify-between">
                                        <h4 className="font-semibold text-gray-900">{appointment.patient.name}</h4>
                                        <span className="rounded bg-blue-100 px-2 py-1 text-xs text-blue-800">#{appointment.serial_number}</span>
                                    </div>
                                    <p className="mb-1 text-sm text-gray-600">ID: {appointment.patient.patient_id}</p>
                                    <p className="mb-2 text-sm text-gray-600">Dr. {appointment.doctor.user.name}</p>
                                    <div className="flex items-center justify-between">
