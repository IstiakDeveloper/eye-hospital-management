...
import { BarChart3, Calendar, PieChart, Target, TrendingDown, TrendingUp } from 'lucide-react';
...
const Analytics: React.FC<AnalyticsProps> = ({ monthlyTrend, purchaseVsSales, topExpenseCategories, profitMargin, year, month }) => {
                                    ...
                                    <div key={index} className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <div className="mb-1 flex items-center">
                                                <span className="w-16 text-xs text-green-600">Income:</span>
                                                <div className="mr-2 h-2 flex-1 rounded-full bg-gray-200">
                                                    <div
                                                        className="h-2 rounded-full bg-green-500"
                                                        style={{ width: `${(item.income / maxAmount) * 100}%` }}
                                                    />
                                                </div>
                                                <span className="w-20 text-right text-xs text-gray-600">{formatAmount(item.income)}</span>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <span className="w-20 text-right text-xs text-gray-600">{formatAmount(item.expense)}</span>
                                            </div>
                                        </div>
                                    </div>
                                );
                                ...
                                return (
                                    <div key={index} className="space-y-2">
                                        ...
                                        <div className="relative">
                                            {/* Sales Bar */}
                                            <div className="mb-1 flex items-center">
                                                <span className="w-16 text-xs text-green-600">Sales:</span>
                                                <div className="mr-2 h-2 flex-1 rounded-full bg-gray-200">
                                                    <div
                                                        className="h-2 rounded-full bg-green-500"
                                                ...
                                                <span className="w-20 text-right text-xs text-gray-600">{formatAmount(sale.total)}</span>
                                            </div>

                                            {/* Purchase Bar */}
                                            <div className="flex items-center">
                                                <span className="w-16 text-xs text-orange-600">Purchase:</span>
                                                <div className="mr-2 h-2 flex-1 rounded-full bg-gray-200">
                                                    <div
                                                ...
                                                <span className="w-20 text-right text-xs text-gray-600">{formatAmount(purchase?.total || 0)}</span>
                                            </div>
                                        </div>
                                    </div>
                                );
            ...
            <div className="mb-8 rounded-lg border bg-white shadow-sm">
                <div className="border-b p-6">
                    ...
                    <p className="text-sm text-gray-600">
                        Breakdown by category for {months[month - 1]} {year}
                    </p>
                </div>
                                    ...
                                    <div key={index} className="space-y-2">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                ...
                                                <span className="ml-2 text-xs text-gray-500">({category.count} transactions)</span>
                                            </div>
                                            <span className="text-sm font-bold text-gray-900">{formatAmount(category.amount)}</span>
                                        </div>
                ...
                <div className="p-6">
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                        <div className="rounded-lg bg-green-50 p-4">
                            <h4 className="mb-2 font-medium text-green-800">Profitability</h4>
                            <p className="text-sm text-green-700">
                                {profitMargin > 25
                                    ? 'Excellent profit margin! Your business is highly profitable.'
                                    : profitMargin > 15
                                      ? 'Good profit margin. Consider optimizing costs for better returns.'
                                      : profitMargin > 5
                                        ? 'Fair profit margin. Focus on increasing sales or reducing costs.'
                                        : 'Low profit margin. Review pricing strategy and cost management.'}
                            </p>
                        </div>

                        <div className="rounded-lg bg-blue-50 p-4">
                            <h4 className="mb-2 font-medium text-blue-800">Growth Trend</h4>
                            <p className="text-sm text-blue-700">
                                {incomeGrowth > 10
                                    ? 'Strong revenue growth! Maintain current strategies.'
                                    : incomeGrowth > 0
                                      ? 'Positive growth trend. Look for acceleration opportunities.'
                                      : 'Revenue declining. Consider marketing and customer retention strategies.'}
                            </p>
                        </div>

                        <div className="rounded-lg bg-purple-50 p-4">
                            <h4 className="mb-2 font-medium text-purple-800">Cost Management</h4>
                            <p className="text-sm text-purple-700">
                                {expenseGrowth < 0
                                    ? 'Great cost control! Expenses are decreasing.'
                                    : expenseGrowth < incomeGrowth
                                      ? 'Good expense management relative to income growth.'
