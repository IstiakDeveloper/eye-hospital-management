...
const Ledger: React.FC<LedgerProps> = ({ ledgerData, investorNames, filters, totals }) => {
    const [startDate, setStartDate] = useState(filters.start_date || '');
    const [endDate, setEndDate] = useState(filters.end_date || '');
    const [investorName, setInvestorName] = useState(filters.investor_name || '');
    ...
    const handleFilter = () => {
        ...
        if (investorName) params.investor_name = investorName;

        router.get('/hospital-account/fund-ledger', params, {
            preserveState: true,
            preserveScroll: true,
        });
    };
