            ...
            <div className="p-4 sm:p-6 lg:p-8">
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-600">Income report for new patient consultations (OPD)</p>
                    </div>
                </div>
                    ...
                    <table className="report-table min-w-full table-auto border-separate border-spacing-0 print:border-collapse">
                        <thead className="bg-gray-50">
                            <tr className="bg-blue-100">
                                <th className="sticky top-0 z-10 border border-gray-300 bg-blue-100 px-3 py-2 text-center text-xs font-semibold text-gray-900 print:static">
                                    SL
                                </th>
                                <th className="sticky top-0 z-10 border border-gray-300 bg-blue-100 px-3 py-2 text-center text-xs font-semibold text-gray-900 print:static">
                                    DATE
