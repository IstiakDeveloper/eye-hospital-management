...
export default function FollowupPatientIncomeReport({ reportData = [], totals, filters }: Props) {
    ...
    const handleFilter = () => {
        router.get(
            route('reports.followup-patient-income'),
            {
                from_date: fromDate,
                to_date: toDate,
    ...
    const handleExportExcel = () => {
        ...
        excelData.push([
            ...
            '',
            'TOTAL',
            totals.total_followup_fee.toFixed(2),
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'Followup Patient Income');

        XLSX.writeFile(wb, `Followup_Patient_Income_Report_${fromDate}_to_${toDate}.xlsx`);
    };

    return (
        <AdminLayout>
            <Head title="Followup Patient Income Report" />
