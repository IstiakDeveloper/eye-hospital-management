...
export default function DueReport({
    ...
    const filteredVendors = vendorsWithDues
        .filter(vendor =>
                                ...
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <div className="grid grid-cols-2 gap-4 text-sm">
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium text-red-600">{formatCurrency(selectedVendor.current_balance)}</span>
                                        </div>
                                        <div className="flex justify-between">
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium text-gray-900">
                                                {formatCurrency(Math.max(0, selectedVendor.current_balance - (parseFloat(data.amount) || 0)))}
                                            </span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Status after payment:</span>
                                            <span className={`font-medium ${
                                                (parseFloat(data.amount) || 0) >= selectedVendor.current_balance
                                                    ? 'text-green-600' : 'text-yellow-600'
                                            }`}>
                                                {(parseFloat(data.amount) || 0) >= selectedVendor.current_balance ? 'Fully Paid' : 'Partially Paid'}
                                            </span>
                                        </div>
                                    </div>
                                </div>
