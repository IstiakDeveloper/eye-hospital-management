                ...
                <div className="mx-auto max-w-7xl">
                    <div className="mb-6 flex items-center justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-gray-600">Manage and track all test bookings</p>
                        </div>
                    ...
                    <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-4">
                        <div className="rounded-lg bg-gradient-to-br from-blue-500 to-blue-600 p-6 text-white shadow">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm text-blue-100">{dateFrom || dateTo ? 'Selected Period Total' : "Today's Total"}</p>
                                    <p className="mt-1 text-3xl font-bold">{formatCurrency(safeStats.today_total)}</p>
                                    {(dateFrom || dateTo) && (
                        ...
                        <div className="rounded-lg bg-gradient-to-br from-green-500 to-green-600 p-6 text-white shadow">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm text-green-100">{dateFrom || dateTo ? 'Period Paid' : "Today's Paid"}</p>
                                    <p className="mt-1 text-3xl font-bold">{formatCurrency(safeStats.today_paid)}</p>
                                </div>
                        ...
                        <div className="rounded-lg bg-gradient-to-br from-red-500 to-red-600 p-6 text-white shadow">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm text-red-100">{dateFrom || dateTo ? 'Period Due' : "Today's Due"}</p>
                                    <p className="mt-1 text-3xl font-bold">{formatCurrency(safeStats.today_due)}</p>
                                </div>
                        ...
                        <div className="rounded-lg bg-gradient-to-br from-purple-500 to-purple-600 p-6 text-white shadow">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm text-purple-100">Pending Payments</p>
                                    <p className="mt-1 text-3xl font-bold">{safeStats.pending_count}</p>
                                    {(dateFrom || dateTo) && <p className="mt-1 text-xs text-purple-100">In selected period</p>}
                                </div>
                            ...
                            <div className="flex gap-3">
                                ...
                                <div className="relative ml-auto">
                                    <button
                                        ...
                                        className="flex items-center gap-2 rounded-lg bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-2 text-white shadow-lg transition hover:from-purple-700 hover:to-indigo-700"
                                    >
                                        <BarChart3 className="h-4 w-4" />
                                        Reports
                                        <ChevronRight className={`h-4 w-4 transition-transform ${showReportMenu ? 'rotate-90' : ''}`} />
                                    </button>
                                    ...
                                    {showReportMenu && (
                                        <div className="absolute right-0 z-50 mt-2 w-56 rounded-lg border border-gray-200 bg-white py-2 shadow-xl">
                                            ...
                                            <button
                                                ...
                                                className="flex w-full items-center gap-3 px-4 py-3 text-left transition hover:bg-purple-50"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="flex w-full items-center gap-3 px-4 py-3 text-left transition hover:bg-green-50"
                                            >
                                            ...
                                            <tr key={group.id} className="transition hover:bg-gray-50">
                                                <td className="px-6 py-4">
                                                    <div>
                                                        ...
                                                        {group.visit && <div className="text-xs text-gray-500">Visit: {group.visit.visit_id}</div>}
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4">
                                                    <div>
                                                ...
                                                <td className="px-6 py-4 text-center">{getStatusBadge(group.payment_status)}</td>
                                                <td className="px-6 py-4">
