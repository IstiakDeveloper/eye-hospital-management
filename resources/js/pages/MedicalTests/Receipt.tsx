...
import { Printer, ArrowLeft, Stethoscope, FileCheck } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="receipt-box bg-white">
        ...
        <div className="bg-gradient-to-r from-blue-700 to-blue-900 text-white p-2 mb-2 rounded">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Stethoscope className="h-6 w-6" />
              <div>
                <h2 className="header-text font-bold">নওগাঁ ইসলামিয়া চক্ষু হাসপাতাল</h2>
                <p className="subheader-text">Circuit House Road, Naogaon • 01307-885566</p>
              </div>
            </div>
            <div className="text-right">
              <div className="bg-white text-blue-900 px-3 py-1 rounded font-bold text-xs">
                TEST RECEIPT
              </div>
              <div className="text-xs mt-1">{testGroup.group_number}</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-4 gap-2 total-text mb-2">
          ...
          <div className={testGroup.total_discount > 0 ? '' : 'col-span-2'}>
