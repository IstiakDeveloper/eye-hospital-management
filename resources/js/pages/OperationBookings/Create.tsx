...
export default function OperationBookingCreate({ patient: initialPatient, operations, doctors }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const formData = {
            ...
            payment_method: advanceAmount > 0 ? paymentMethod : undefined,
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-4">
                                        <div className="grid grid-cols-3 gap-4 text-center">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-xl font-bold text-green-600">৳{advanceAmount.toFixed(2)}</div>
                                            </div>
                                            <div>
                                                <div className="text-sm text-gray-600">Due Amount</div>
                                                <div className="text-xl font-bold text-red-600">৳{dueAmount.toFixed(2)}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
