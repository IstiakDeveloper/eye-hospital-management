...
import { BadgeDollarSign, GraduationCap, Mail, Phone, Save, Stethoscope, User as UserIcon, UserPlus, X } from 'lucide-react';
        ...
        <AdminLayout title="Add New Doctor">
            ...
            <Card className="mx-auto max-w-3xl">
                <CardHeader>
                    ...
                    <CardDescription>
                        {user ? 'Create a doctor profile for the selected user.' : 'Create a new user account and doctor profile.'}
                    </CardDescription>
                </CardHeader>
                ...
                <form onSubmit={handleSubmit}>
                    <CardContent className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                {user && (
                                    <Button type="button" variant="outline" size="sm" onClick={toggleUserCreation}>
                        ...
                        <div className="space-y-4 border-t border-gray-200 pt-6">
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div>
                                    <label htmlFor="consultation_fee" className="mb-1 block text-sm font-medium text-gray-700">
                                        Consultation Fee *
                                    </label>
                                    <Input
                                        id="consultation_fee"
                                ...
                                <div>
                                    <label htmlFor="follow_up_fee" className="mb-1 block text-sm font-medium text-gray-700">
                                        Follow-up Fee
                                    </label>
                                    <Input
                                        id="follow_up_fee"
                    ...
                    <CardFooter className="flex justify-between">
                        <Button type="button" variant="outline" icon={<X className="h-4 w-4" />} href={route('doctors.index')}>
                            Cancel
                        </Button>
