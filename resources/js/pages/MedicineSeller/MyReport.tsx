...
import { BarChart3, Calendar as CalendarIcon, DollarSign, Download, FileText, Package, TrendingUp } from 'lucide-react';
...
export default function MyReport({ salesSummary, topMedicines, totalSales, totalTransactions, dateFrom, dateTo }: MyReportProps) {
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                    <div>
                        ...
                        <p className="mt-1 text-gray-600">Analyze your personal sales performance</p>
                    </div>
                    ...
                    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-2xl font-bold text-green-600">{totalTransactions}</p>
                    ...
                    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-2xl font-bold text-purple-600">{salesSummary.length}</p>
                                <p className="mt-1 text-sm text-gray-500">Days with sales</p>
                            </div>
                    ...
                    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                        ...
                        <div className="max-h-80 space-y-4 overflow-y-auto">
                            {topMedicines.slice(0, 10).map((medicine, index) => (
                                <div key={medicine.name} className="rounded-lg border border-gray-200 p-4 transition-colors hover:bg-gray-50">
                                    <div className="flex items-start justify-between">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1">
                                                <h3 className="mb-1 text-sm font-medium text-gray-900">{medicine.name}</h3>
                                                <div className="flex items-center gap-4 text-xs text-gray-500">
                                                    <span>
                                                        Qty: {medicine.total_quantity} {medicine.unit}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
