        ...
        <OpticsAccountLayout title="Transactions">
            ...
            <div className="mb-6 rounded-lg border bg-white p-6 shadow-sm">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-5">
                    ...
                    <button onClick={handleFilter} className="rounded-lg bg-purple-600 px-4 py-2 text-white hover:bg-purple-700">
                        Filter
                    </button>
                                    ...
                                    <td className="px-6 py-4 text-sm text-gray-900">
                                        <span
                                            className={`rounded px-2 py-1 text-xs ${
                                                transaction.category === 'glasses_sale'
                                                    ? 'bg-green-50 text-green-700'
                                                    : transaction.category === 'lens_sale'
                                                      ? 'bg-blue-50 text-blue-700'
                                                      : transaction.category === 'glasses_purchase'
                                                        ? 'bg-orange-50 text-orange-700'
                                                        : transaction.category === 'lens_purchase'
