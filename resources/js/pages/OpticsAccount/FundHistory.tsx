...
import { Glasses, TrendingDown, TrendingUp } from 'lucide-react';
...
const FundHistory: React.FC<FundHistoryProps> = ({ fundTransactions }) => {
    ...
    return (
        <OpticsAccountLayout title="Fund History">
            {/* Summary Stats */}
                ...
                <div className="rounded-lg border bg-white p-6 shadow-sm">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-purple-600">{formatAmount(totalFundIn)}</p>
                        </div>
                                ...
                                <tr key={transaction.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4">
                                        <span
                                            className={`inline-flex rounded-full px-2 py-1 text-xs font-semibold ${
                                                transaction.type === 'fund_in' ? 'bg-purple-100 text-purple-800' : 'bg-red-100 text-red-800'
                                            }`}
                                        >
                                    ...
                                    <td
                                        className={`px-6 py-4 text-sm font-medium ${
                                            transaction.type === 'fund_in' ? 'text-purple-600' : 'text-red-600'
                                        }`}
                                    >
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex gap-2">
                                {fundTransactions.current_page > 1 && (
                                    <button
                                        onClick={() =>
                                            router.get('/optics-account/fund-history', {
