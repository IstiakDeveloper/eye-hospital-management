...
const OpticsVendorDueLedger: React.FC<LedgerProps> = ({ ledgerData, vendors, filters, totals }) => {
    ...
    const handleFilter = () => {
        ...
        router.get('/hospital-account/vendor-due-ledger/optics', params, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    return (
        <HospitalAccountLayout title="Optics Vendor Due Ledger">
            {/* Filter Section */}
            ...
            <div className="bg-white rounded-lg shadow-sm border report-section">
                ...
                <div className="print-header mb-3 p-4">
                    ...
                    <div className="flex justify-between items-center mt-2">
                        <h2 className="text-sm font-bold">Optics Vendor Due Ledger</h2>
                        <p className="text-xs">
                            {startDate && endDate
...
export default OpticsVendorDueLedger;
