...
const ExpenseVendorDueLedger: React.FC<LedgerProps> = ({ ledgerData, vendors, showVendorColumn, filters, totals }) => {
    ...
    const handleFilter = () => {
        ...
        router.get(route('hospital-account.vendor-due-ledger.due-expense'), params, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    return (
        <HospitalAccountLayout title="Due Expense Vendor Ledger">
            ...
            <div className="report-section rounded-lg border bg-white shadow-sm">
                <div className="print-header mb-3 p-4">
                    ...
                    <div className="mt-2 flex items-center justify-between">
                        <h2 className="text-sm font-bold">Due Expense Vendor Ledger</h2>
                        <p className="text-xs">
                    ...
                    <table className="w-full">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-right text-xs font-medium tracking-wider text-gray-500 uppercase">Expense Due</th>
                            ...
                            {ledgerData.length === 0 ? (
                                ...
                                ledgerData.map((item) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 font-mono text-sm whitespace-nowrap text-gray-700">{item.reference}</td>
...
export default ExpenseVendorDueLedger;
