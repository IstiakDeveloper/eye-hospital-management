...
const Input = ({ label, error, className = '', ...props }: any) => (
    <div className={className}>
        ...
        <input
            className={`w-full rounded-lg border px-3 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 ${error ? 'border-red-300' : 'border-gray-300'}`}
            {...props}
        />
    ...
    const handleExportExcel = async () => {
        ...
        try {
            ...
            const excelData = safeFrames.map((frame: Frame, index: number) => ({
                ...
                'Stock Status': frame.stock_quantity === 0 ? 'Out of Stock' : frame.is_low_stock ? 'Low Stock' : 'In Stock',
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-blue-100">Professional A4 format report ({totalFrames} frames)</p>
                            </div>
                        </div>
                ...
                <div className="border-b bg-gray-50 p-6">
                    <div className="flex items-center space-x-4">
                        ...
                        <Input
                            ...
                            className="max-w-xs"
                        />
                        <Button variant="success" onClick={handleExportExcel} disabled={totalFrames === 0 || exportingExcel}>
                ...
                <div className="flex-1 overflow-auto bg-gray-100 p-6">
                    {totalFrames === 0 ? (
                        <div className="py-12 text-center">
                            ...
                            <h3 className="mb-2 text-lg font-medium text-gray-900">No frames to print</h3>
                                    ...
                                    {safeFrames.map((frame: Frame, index: number) => {
                                        ...
                                        return (
                                            <tr key={frame.id}>
                                                ...
                                                <td className={`stock-col ${stockStatus.color}`}>{frame.stock_quantity}</td>
                                                ...
                                                <td className={`price ${profit >= 0 ? 'profit-pos' : 'profit-neg'}`}>৳{profit.toLocaleString()}</td>
                                                <td>
