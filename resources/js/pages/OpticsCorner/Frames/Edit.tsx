            ...
            <div className="space-y-6">
                ...
                <div className="rounded-xl border bg-white p-8 shadow-sm">
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <Select label="Type *" value={data.type} onChange={(e: any) => setData('type', e.target.value)} error={errors.type}>
                        ...
                        <Select label="Gender *" value={data.gender} onChange={(e: any) => setData('gender', e.target.value)} error={errors.gender}>
