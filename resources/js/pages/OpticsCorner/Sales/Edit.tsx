                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                        <p className="text-sm text-gray-600">
                            Original Total: <span className="font-semibold">৳{sale.total_amount.toLocaleString()}</span>
                        </p>
                        <p className="text-sm text-gray-600">
                            Original Due: <span className="font-semibold text-red-600">৳{sale.due_amount.toLocaleString()}</span>
                        </p>
                    </div>
                </div>
                ...
                <div className="rounded-xl border bg-white p-6 shadow-sm">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-8 rounded-lg bg-blue-50 p-6">
                            <h3 className="mb-4 text-lg font-semibold text-gray-900">Payment & Calculation</h3>
                        ...
                        <div className="flex justify-end space-x-4">
                            ...
                            <Button type="submit" disabled={processing || calculateTotal() <= 0 || data.items.some((item) => !item.id)}>
