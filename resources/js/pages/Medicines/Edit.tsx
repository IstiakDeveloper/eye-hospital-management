        ...
        <AdminLayout title="Edit Medicine">
            ...
            <Card className="mx-auto max-w-3xl">
                <CardHeader>
                    ...
                    <CardDescription>Update the details of {medicine.name}.</CardDescription>
                </CardHeader>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <CardFooter className="flex justify-between">
                        <div className="flex gap-3">
                            <Button type="button" variant="outline" icon={<X className="h-4 w-4" />} href={route('medicines.index')}>
                                Cancel
                            </Button>
