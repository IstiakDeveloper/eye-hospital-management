        ...
        <AdminLayout title="Users Management">
            ...
            <div className="space-y-6">
                ...
                <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
                    ...
                    {can.create && (
                        <Button href={route('users.create')} className="bg-blue-600 text-white shadow-sm hover:bg-blue-700">
                        ...
                        <div className="overflow-x-auto">
                            {users?.data?.length > 0 ? (
                                    ...
                                    <TableBody>
                                        {users.data?.map((user) => (
                                            <TableRow key={user.id} className="hover:bg-gray-50">
                                                ...
                                                <TableCell>
                                                    <Badge variant="secondary" className={`${getRoleBadgeColor(user.role.name)} border`}>
                                                        {user.role.name}
                                                    </Badge>
                                                </TableCell>
                                                <TableCell>
                                                            ...
                                                            {can.edit && (
                                                                <>
                                                                    ...
                                                                    <DropdownMenuItem
                                                                        ...
                                                                        className={`flex cursor-pointer items-center ${user.is_active ? 'text-red-600' : 'text-green-600'}`}
                                                                    >
                                                                        {user.is_active ? (
                                                                            <>
                                ...
                                <div className="px-6 py-12 text-center">
                                    ...
                                    {can.create && (
                                        <Button href={route('users.create')} className="bg-blue-600 hover:bg-blue-700">
                                            <UserPlus className="mr-2 h-4 w-4" />
                                            Add First User
                                        </Button>
                                    )}
