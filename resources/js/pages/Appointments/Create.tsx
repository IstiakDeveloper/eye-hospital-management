...
import { AlertCircle, Calendar, Clock, Save, Search, User, UserPlus, X } from 'lucide-react';
                                        ...
                                        <div className="flex">
                                            ...
                                            <div className="ml-3">
                                                <p className="text-sm text-blue-700">
                                                    ...
                                                    {searchResults.find((p) => p.id === Number(data.patient_id))?.name || 'Patient'}
                                                </p>
                                                <div className="mt-1">
                                                    <Button
                                                        size="sm"
                ...
                <form onSubmit={handleSubmit}>
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Select a doctor, date, and time for the appointment.</CardDescription>
                        </CardHeader>
                        ...
                        <CardContent className="space-y-6">
                                    ...
                                    <div className="flex">
                                        ...
                                        <div className="ml-3">
                                            ...
                                            <p className="text-sm text-blue-700">
                                                ...
                                                <span className="ml-2 font-medium">Phone:</span> {patient.phone}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label htmlFor="doctor_id" className="mb-1 block text-sm font-medium text-gray-700">
                                        Select Doctor *
                                    </label>
                                    <Select
                                        id="doctor_id"
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    <div>
                                        <label htmlFor="appointment_date" className="mb-1 block text-sm font-medium text-gray-700">
                                            Appointment Date *
                                        </label>
                                        <Input
                                            id="appointment_date"
                                    ...
                                    <div>
                                        <label htmlFor="appointment_time" className="mb-1 block text-sm font-medium text-gray-700">
                                            Appointment Time *
                                        </label>
                                        <Input
                                            id="appointment_time"
