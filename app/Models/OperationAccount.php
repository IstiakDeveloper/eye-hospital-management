...
class OperationAccount extends Model
{
    ...
    public static function addFund(float $amount, string $purpose, string $description, ?string $date = null): void
    {
        ...
        MainAccount::createCreditVoucher(
            amount: $amount,
            narration: "Operation Fund In - {$purpose}: {$description}",
            sourceAccount: 'operation',
    ...
    public static function withdrawFund(float $amount, string $purpose, string $description, ?string $date = null): void
    {
        ...
        MainAccount::createDebitVoucher(
            amount: $amount,
            narration: "Operation Fund Out - {$purpose}: {$description}",
            sourceAccount: 'operation',
    ...
    public static function addIncome(
        ...
        MainAccount::createCreditVoucher(
            amount: $amount,
            narration: "Operation Income - {$category}: {$description}",
            sourceAccount: 'operation',
    ...
    public static function addExpense(
        ...
        MainAccount::createDebitVoucher(
            amount: $amount,
            narration: "Operation Expense - {$category}: {$description}",
            sourceAccount: 'operation',
