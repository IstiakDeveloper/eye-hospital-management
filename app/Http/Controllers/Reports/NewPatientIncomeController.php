...
class NewPatientIncomeController extends Controller
{
    /**
     * Display New Patient Income Report
     * Shows income from new patients (is_followup = false)
     */
    public function index(Request $request)
    {
        ...
        // Get new patient visits with doctor info
        ...
        $reportData = $visits->map(function ($visit, $index) {
            return [
                ...
                'consultation_fee' => (float) $visit->doctor_fee,
        ...
        $totals = [
            ...
            'total_consultation_fee' => $visits->sum('doctor_fee'),
        ...
        return Inertia::render('HospitalCorner/Reports/NewPatientIncomeReport', [
